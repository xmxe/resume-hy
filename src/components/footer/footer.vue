<template>
  <footer>
    ...
    <a href="https://github.com/xmxe" title="GitHub" :target="target" v-show="isEnd">
      <svg width="28" height="24" class="icon" viewBox="0 0 16 16" version="1.1" aria-hidden="true">
    ...
    <a href="https://gitee.com/xmxe" title="码云" :target="target" v-show="isEnd">
      <svg width="24" height="24" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="991" xmlns:xlink="http://www.w3.org/1999/xlink">
        <path d="M512 1024C229.222 1024 0 794.778 0 512S229.222 0 512 0s512 229.222 512 512-229.222 512-512 512z m259.149-568.883h-290.74a25.293 25.293 0 0 0-25.292 25.293l-0.026 63.206c0 13.952 11.315 25.293 25.267 25.293h177.024c13.978 0 25.293 11.315 25.293 25.267v12.646a75.853 75.853 0 0 1-75.853 75.853h-240.23a25.293 25.293 0 0 1-25.267-25.293V417.203a75.853 75.853 0 0 1 75.827-75.853h353.946a25.293 25.293 0 0 0 25.267-25.292l0.077-63.207a25.293 25.293 0 0 0-25.268-25.293H417.152a189.62 189.62 0 0 0-189.62 189.645V771.15c0 13.977 11.316 25.293 25.294 25.293h372.94a170.65 170.65 0 0 0 170.65-170.65V480.384a25.293 25.293 0 0 0-25.293-25.267z" fill="#000" p-id="992">
        </path>
    </svg>
    </a>
    <a href="https://xmxe.github.io/blog" title="博客" :target="target" v-show="isEnd">
      <svg width="25" height="24" class="icon" viewBox="0 0 412 542" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="javascript:;" title="微信" v-show="isEnd" @mouseenter="qrcodeShow=!qrcodeShow" @mouseleave="qrcodeShow=!qrcodeShow">
      <svg width="28" height="24" class="icon" viewBox="0 0 370 255" xmlns="http://www.w3.org/2000/svg">
