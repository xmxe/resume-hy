<template>
  <footer>
    ...
    <a href="https://xmxe.github.io/blog" title="博客" :target="target" v-show="isEnd">
      <svg width="23" height="26" class="icon" viewBox="0 0 48 43" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="javascript:;" title="微信" v-show="isEnd" @mouseenter="qrcodeShow=!qrcodeShow" @mouseleave="qrcodeShow=!qrcodeShow">
      <svg width="43" height="28" class="icon" viewBox="0 0 590 210" xmlns="http://www.w3.org/2000/svg">
