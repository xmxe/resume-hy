<template>
  <footer>
    <a href="#" v-show="!isEnd" @click.prevent="togglePause" v-html="text"></a>
    <a href="#" v-show="!isEnd" @click.prevent="skip">
    ...
    <a href="https://github.com/xmxe/" v-show="isEnd">
    ...
    <a href="https://gitee.com/xmxe/" v-show="isEnd">
