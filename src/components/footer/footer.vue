<template>
  <footer>
    ...
    <a href="https://gitee.com/xmxe" title="码云" :target="target" v-show="isEnd">
      <svg width="22" height="21" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="991" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <a href="javascript:;" title="微信" v-show="isEnd" @mouseenter="qrcodeShow=!qrcodeShow" @mouseleave="qrcodeShow=!qrcodeShow">
      <svg width="24" height="24" class="icon" viewBox="0 0 340 235" xmlns="http://www.w3.org/2000/svg">
