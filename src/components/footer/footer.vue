<template>
  <footer>
    ...
    <a href="https://xmxe.github.io/blog" title="博客" :target="target" v-show="isEnd">
      <svg width="26" height="24" class="icon" viewBox="0 0 512 542" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="javascript:;" title="微信" v-show="isEnd" @mouseenter="qrcodeShow=!qrcodeShow" @mouseleave="qrcodeShow=!qrcodeShow">
      <svg width="43" height="28" class="icon" viewBox="0 0 590 215" xmlns="http://www.w3.org/2000/svg">
